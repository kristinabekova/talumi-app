...
import { GameTopBar } from "../talumi/GameChrome";
...
export default function SnakeGame({ onBack }: { onBack?: () => void }) {
  ...
  return <div className="talumi-app">
    <div className="snake-topbar"><GameTopBar title="Energický had" onBack={backToGames} onPause={inGame ? game.pause : undefined} sound={game.soundOn} onToggleSound={() => game.setSoundOn(!game.soundOn)} /></div>
