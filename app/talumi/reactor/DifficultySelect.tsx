...
const REGIONS: {
  ...
  },
  {
    ...
    detail: "Počítanie s desiatkami a dvojcifernými číslami bez prechodu cez základ.",
  ...
  },
  {
    ...
    detail: "Komplexnejšie sčítanie s prechodom. Plná výzva pre pokročilejších hráčov.",
